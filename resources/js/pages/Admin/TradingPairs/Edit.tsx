...
export default function Edit({ pair }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(route('admin.trading-pairs.update', pair.id), {
            onSuccess: () => {
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Edit ${pair.pair_symbol}`} />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit {pair.pair_symbol}</h1>
                        <p className="text-muted-foreground">
                            Modify trading pair configuration and collection settings
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            min="1"
                                            max="100"
                                            value={data.collection_config?.rows || 50}
                                    ...
                                    <div>
                                        ...
                                        <Select 
                                            value={data.collection_config?.priority || 'medium'} 
                    ...
                    <div className="flex items-center justify-end gap-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Updating...' : 'Update Trading Pair'}
                        </Button>
                    </div>
                </form>
            </div>
